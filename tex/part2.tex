...
$f_{score}$ which is flexible by design, can find the best visualization which respects the new constraints.
This is a task that $AUC_{log}RNX$ or BIC-based score can not do.
