...
\begin{figure*}
     ...
     \begin{subfigure}[b]{0.45\textwidth}
         \centering
         \includegraphics[width=\textwidth]{DIGITS_umap_predicted_score}
...
\begin{figure*}
\centering
\includegraphics[width=\textwidth]{{DIGITS_umap_metamap}.png}
...
\begin{subfigure}[b]{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{{COIL20_tsne_metamap}.png}
    \caption{Metamap for tSNE embeddings of COIL20 dataset.}
\end{subfigure}
~
\begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{COIL20_tsne_show}
...
\begin{subfigure}[b]{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{{FASHION1000_tsne_metamap}.png}
    \caption{Metamap for tSNE embeddings of FASHION1000 dataset.}
\end{subfigure}
~
\begin{subfigure}[b]{\textwidth}
...
\begin{subfigure}[b]{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{{FASHION_MOBILENET_tsne_metamap}.png}
    \caption{Metamap for tSNE embeddings of FASHION\_MOBILENET dataset.}
\end{subfigure}
~
\begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{FASHION_MOBILENET_tsne_show}
    \caption{Sample vizs FASHION\_MOBILENET}
\end{subfigure}
\end{figure*}
...
\begin{subfigure}[b]{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{{20NEWS5_tsne_metamap}.png}
    \caption{Metamap for tSNE embeddings of 20NEWS5 dataset.}
\end{subfigure}
~
\begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{20NEWS5_tsne_show}
    \caption{Sample vizs 20NEWS5}
\end{subfigure}
\end{figure*}
...
\begin{subfigure}[b]{\textwidth}
    ...
    \caption{Metamap for tSNE embeddings of NEURON\_1K dataset.}
\end{subfigure}
~
\begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{NEURON_1K_tsne_show}
    \caption{Sample vizs NEURON\_1K}
\end{subfigure}
\end{figure*}
...
~
\begin{subfigure}[b]{\textwidth}
    \includegraphics[width=\textwidth]{DIGITS_umap_show}
    \caption{Sample vizs DIGITS}
\end{subfigure}
\end{figure*}
...
\begin{subfigure}[b]{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{{FASHION_MOBILENET_umap_metamap}.png}
    \caption{Metamap for UMAP embeddings of FASHION\_MOBILENET dataset.}
\end{subfigure}
~
\begin{subfigure}[b]{\textwidth}
    % \includegraphics[width=\textwidth]{FASHION_MOBILENET_umap_show}
    \caption{Sample vizs FASHION\_MOBILENET}
\end{subfigure}
\end{figure*}
...
\begin{subfigure}[b]{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{{20NEWS5_umap_metamap}.png}
    \caption{Metamap for UMAP embeddings of 20NEWS5 dataset.}
\end{subfigure}
~
\begin{subfigure}[b]{\textwidth}
    % \includegraphics[width=\textwidth]{20NEWS5_umap_show}
    \caption{Sample vizs 20NEWS5}
\end{subfigure}
\end{figure*}
...
\begin{subfigure}[b]{\textwidth}
    \centering
    \includegraphics[width=\textwidth]{{NEURON_1K_umap_metamap}.png}
    \caption{Metamap for UMAP embeddings of NEURON\_1K dataset.}
\end{subfigure}
~
\begin{subfigure}[b]{\textwidth}
    % \includegraphics[width=\textwidth]{NEURON_1K_umap_show}
    \caption{Sample vizs NEURON\_1K}
\end{subfigure}
\end{figure*}
