...
\begin{figure}
\centering
\includegraphics[scale=0.25]{sall_perp30.pdf}
...
+ Compare our score with John's score? (Apply BayOpt to John's metric, compare the predictive score function - the prediction line in the graphs, compare the optimal hyperparameter).

+ Compare our result with the method of auto-selecting perplexity of Cao and Wang?
