...
In this paper, we show how to automatically choose the hyperparameters of DR techniques, such as the {\it perplexity} of $t$-SNE, by considering pariwise constraints.
...
in form of pair of input sample and function values.
...
Several strategies exist to guide the optimization process to discover the parameter space: \emph{Maximum Probability of Improvement (MPI)}~\cite{}, \emph{Expected Improvement (EI)}~\cite{}, \emph{lower or upper confidence bound (UCB, LCB)}~\cite{}.
